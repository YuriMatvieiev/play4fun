(() => {
    ...
    var isConfirmationCachingEnabled = true;
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (popup && isPopupVisible) {
            ...
            popupButton.addEventListener("click", (function() {
                ...
                if (isConfirmationCachingEnabled) localStorage.setItem("ageConfirmed", "true");
            }));
        }
    }));
    function isWebp() {
    ...
    if (gameResize) gameResize.addEventListener("click", (function() {
